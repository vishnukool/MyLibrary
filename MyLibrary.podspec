...
Pod::Spec.new do |s|
  s.name             = 'MyLibrary'
  s.version          = '0.0.1'
  s.summary          = 'It does shit of MyLibrary.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/vishnukool/MyLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Vishnu' => '857006+vkkong@users.noreply.github.com' }
  s.source           = { :git => 'https://github.com/vishnukool/MyLibrary.git', :tag => s.version.to_s }
